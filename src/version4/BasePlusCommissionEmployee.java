...
public class BasePlusCommissionEmployee extends CommissionEmployee {
    ...
    public String toString() {
        return String.format(
                "BasePlusCommissionEmployee [ID: %d, Name: %s, DOB: %s, Hired: %s, Sale: PHP%.2f, Base: PHP%.2f, Commission Rate: %.0f%%]", getEmpID(), getEmpName(), getBirthDate(), getDateHired(), getTotalSale(), baseSalary, getCommissionRate() * 100);
    }
